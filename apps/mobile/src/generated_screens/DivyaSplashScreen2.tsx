...
export default function DivyaSplashScreen2() {
  return (
    <ScrollView className="flex-1 bg-background" contentContainerStyle={{ flexGrow: 1 }}>
      
<View className="bg-[#7E1E1E] flex flex-col items-center justify-center flex-1">
<TouchableOpacity className="relative w-full flex-1 flex flex-col items-center justify-center rangoli-overlay cursor-pointer">
...
<Text className="material-symbols-outlined text-[600px] text-white">{"local_florist"}</Text></View></TouchableOpacity>
