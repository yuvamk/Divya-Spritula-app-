...
export default function LocalDevoteeHome1() {
  return (
...
<TouchableOpacity className="flex-shrink-0 flex flex-col items-center gap-2">
...
<Text className="text-xs font-bold text-on-surface/80">{"Donate"}</Text></TouchableOpacity>
...
<View className="w-16 h-16 rounded-full bg-[#7E1E1E] flex items-center justify-center shadow-lg active:scale-90 transition-transform cursor-pointer">
<Text className="material-symbols-outlined text-white text-3xl">{"local_florist"}</Text></View>
<Text className="text-xs font-bold text-on-surface/80">{"Book Puja"}</Text></TouchableOpacity>
<View className="flex-shrink-0 flex flex-col items-center gap-2">
...
<Text className="text-xs font-bold text-on-surface/80">{"Updates"}</Text></TouchableOpacity></View></View>
...
<TouchableOpacity className="w-full block">
<TouchableOpacity className="w-full bg-saffron-gradient text-white py-4 rounded-xl font-bold uppercase tracking-widest text-sm shadow-md active:scale-[0.98] transition-all">{"Daan Do"}</TouchableOpacity></TouchableOpacity></View></View></View>
...
<TouchableOpacity className="flex flex-col items-center justify-center text-[#1A1C1A]/60 dark:text-[#FAF9F6]/60 hover:bg-[#E3E2E0]/50 dark:hover:bg-[#E3E2E0]/10 rounded-xl active:scale-90 transition-transform duration-200 cursor-pointer p-2">
