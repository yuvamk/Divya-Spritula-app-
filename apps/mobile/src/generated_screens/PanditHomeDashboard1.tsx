...
export default function PanditHomeDashboard1() {
  return (
...
<Text className="text-xs text-on-surface-variant font-medium mt-1">{"Registered members"}</Text></View></View>
...
<View className="flex flex-col items-center justify-center text-[#AB2E15] dark:text-[#E8593C] font-bold hover:bg-[#E3E2E0]/50 dark:hover:bg-[#E3E2E0]/10 rounded-xl px-4 py-1 transition-all">
