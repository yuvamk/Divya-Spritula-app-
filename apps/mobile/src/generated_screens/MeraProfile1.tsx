...
export default function MeraProfile1() {
  return (
...
<View className="pt-4 border-t border-outline-variant/20 flex items-center gap-4">
...
<TouchableOpacity className="ember-gradient text-white p-2 rounded-lg flex items-center justify-center shadow-md active:scale-95 transition-transform">
<Text className="material-symbols-outlined text-xl">{"call"}</Text></TouchableOpacity></View></View></View></View>
<View className="space-y-4">
